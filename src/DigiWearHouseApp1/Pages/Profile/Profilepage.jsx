      ...
      try {
        ...
        if (userDoc.exists()) {
          ...
          setProfileData((prevData) => ({
            ...
            coverImage: data.coverImage || "/api/placeholder/800/200",
          }));
        } else {
          setProfileData((prevData) => ({
            ...prevData,
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {categoryOptions.map((category) => {
                    const isSelected =
                      profileData.selectedCategories.includes(category);
                    return (
                      <button
                        key={category}
                        type="button"
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {materialTypeOptions.map((material) => {
                    const isSelected =
                      profileData.materialTypes.includes(material);
                    return (
                      <button
                        key={material}
                        type="button"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-6 lg:gap-8 2xl:gap-12">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("gstnNumber", e.target.value)
                  }
            ...
            <div className="flex flex-col xl:flex-row xl:items-start xl:space-x-16 space-y-8 xl:space-y-0">
              <div className="text-center xl:text-left">
                ...
                <div className="flex items-center justify-center xl:justify-start mb-4">
                  {[...Array(Math.floor(ratingData.averageRating))].map(
                    (_, i) => (
                      <svg
                        key={i}
                  ...
                  {ratingData.averageRating % 1 !== 0 && (
                    ...
                    >
                      <path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z" />
                      <path
                        d="M10 15V0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545L10 15z"
                        fill="gray"
                      />
                    </svg>
                  )}
                  {[...Array(5 - Math.ceil(ratingData.averageRating))].map(
                    (_, i) => (
                      <svg
                        key={i}
                ...
                {ratingData.dressTypeRatings.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-sm text-[#800000] hover:text-blue-600 cursor-pointer">
                        {item.reviews}
                      </div>
                    </div>
                  </div>
            ...
            <div className="mt-6">
              <p className="text-gray-600">
                ...
                <a
                  ...
                  className="text-[#800000] hover:text-blue-600"
                >
                  support@example.com
                </a>
              </p>
  ...
  return (
    <div className="min-h-screen bg-gray-50 w-full">
      ...
      <div className="relative h-48 md:h-64 lg:h-80 bg-gradient-to-r from-orange-400 via-red-500 to-pink-500 w-full">
        ...
        {isEditing ? (
          <label className="absolute top-4 right-4 md:top-6 md:right-6 lg:top-8 lg:right-8 bg-white bg-opacity-20 text-white px-4 py-2 lg:px-6 lg:py-3 rounded-lg text-sm lg:text-base backdrop-blur-sm hover:bg-opacity-30 transition-colors cursor-pointer">
            Change Cover Image
            <input
              type="file"
              accept="image/*"
          ...
          <button
            onClick={handleEdit}
            className="absolute top-4 right-4 md:top-6 md:right-6 lg:top-8 lg:right-8 bg-white bg-opacity-20 text-white px-4 py-2 lg:px-6 lg:py-3 rounded-lg text-sm lg:text-base backdrop-blur-sm hover:bg-opacity-30 transition-colors"
          >
            Edit Profile
          </button>
        )}
